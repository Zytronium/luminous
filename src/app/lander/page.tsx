                ...
                >
                    <div className="relative flex items-center justify-center mb-8">
                        <div
                            ...
                            style={{ width: 100, height: 100, borderRadius: "50%", border: "2px solid #1ED2AF" }}
                        />
                        <div
                            className="animate-pulse-ring absolute"
                            style={{ width: 76, height: 76, borderRadius: "50%", border: "2px solid #1ED2AF" }}
                        />
                        <div
                        ...
                        >
                            <Image src="/logo.png" alt="Luminous" width={64} height={64} style={{ borderRadius: "50%" }} />
                        </div>
                    </div>
                    ...
                    <div className="fade-up-5 flex flex-col sm:flex-row gap-3 w-full">
                        <Link
                            ...
                            style={{ background: "#1ED2AF", color: "#00002e", fontSize: "0.95rem", letterSpacing: "0.02em" }}
                        >
                            Sign In / Join
                        </Link>
                        <GhostButton href="/chat">Open Chat</GhostButton>
                    </div>
                </div>
            </div>
        </>
